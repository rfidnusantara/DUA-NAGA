...
// ==========================
// 1b. (Opsional) Daftar PO dari barang aktif (kalau mau dipakai di tempat lain)
// ==========================
$poStmt = $pdo->query("
...
// ==========================
// 1c. Ambil data API → Mapping PO -> raw name/address
// + FILTER PERUSAHAAN
// ==========================
...
if (is_array($salesOrdersApi)) {
    foreach ($salesOrdersApi as $order) {
        // PO nomor dari API → customer_order.number (biasa)
        $po = trim($order['customer']['customer_order']['number'] ?? $order['customer_order']['number'] ?? '');
        if ($po === '') continue;

        // Nama Customer & alamat, bisa berisi "(1) ... (2) ..."
            ...
            if (!empty($dupInForm)) {
                ...
                try {
                    ...
                    $insertSj->execute([
                        ...
                        ':po_number'       => $poNumber,
                        ':warehouse_id'    => $warehouseId,
                        ':notes'           => $notes,       // <-- simpan keterangan ke header SJ
                        ':created_by'      => $currentUser,
                    ]);
                                ...
                                <div class="col-6">
                                    ...
                                    <select name="po_number" id="po_number" class="form-select form-select-sm">
                                        ...
                                        <?php foreach ($poCustomerMap as $po => $info): ?>
                                            ...
                                            // Ambil nama pertama sebagai label singkat
                                    ...
                                    <div class="form-text small">
                                        PO, nama & alamat diambil langsung dari API dan difilter berdasarkan perusahaan.
                                    </div>
                                </div>
                                <div class="col-6">
