...
<style>
    ...
    /* Animasi pulsing untuk status scanning */
                ...
                <form method="post" autocomplete="off">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-floating mb-2">
                            <input type="text" name="name_label" class="form-control" placeholder="Keterangan">
                            <label>Nama Pemilik / Keterangan</label>
                        </div>
                        <div class="row g-2">
                            <div class="col-6">
                                <div class="form-floating">
...
function setVisualStatus(isScanning) {
    if (isScanning) {
        ...
        btnStop.classList.add('btn-danger'); // Merah menyala saat aktif
    } else {
    ...
    scanTimer = setInterval(() => {
        fetch('get_latest_rfid.php')
            ...
            .then(data => {
                ...
                // Support array 'tags' atau single 'epc'
...
if (btnStart) {
    btnStart.addEventListener('click', () => {
        fetch('rfid_control.php?action=start')
            .then(r => r.json())
            .then(res => {
                // Opsional: bersihkan textarea saat start baru
